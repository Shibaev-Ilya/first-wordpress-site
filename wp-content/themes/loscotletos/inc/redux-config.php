...
$opt_name = 'redux_loscotletos';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
    $opt_name,
    array(
        'title'            => esc_html__( 'Main info Setting', 'loscotletos' ),
        'id'               => 'main-settings',
        'desc'             => esc_html__( 'Settings for website', 'loscotletos' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-website',
    )
);

require_once Redux_Core::$dir . '../sample/sections/header-fields/text.php';
